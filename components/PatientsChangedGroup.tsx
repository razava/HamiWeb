...
export default function PatientsChangedGroup({ userId }: { userId: string }) {
  ...
  const approveMutation = useMutation({
    mutationFn: () => approveOrRejectPatient({ userId, patientGroupId: selectedGroup!, isApproved: true }),
    onSuccess: () => {
