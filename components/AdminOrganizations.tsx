...
// Add Key Form
const AddOrgFormSchema = z.object({
  titleOrg: z.string().min(2, {
...
export default function AdminOrganizations() {
  ...
  // Form Edit
  type EditOrgFormValues = z.infer<typeof EditOrgFormSchema>;
  // This can come from your database or API.
  const defaultValuesEdit: Partial<EditOrgFormValues> = {
    titleOrg: "",
    description: "",
  };

  const formEdit = useForm<EditOrgFormValues>({
  ...
  // Form Add
  type AddOrgFormValues = z.infer<typeof AddOrgFormSchema>;
  // This can come from your database or API.
  const defaultValuesAdd: Partial<AddOrgFormValues> = {
    titleOrg: "",
    description: "",
  };

  const formAdd = useForm<AddOrgFormValues>({
  ...
  function onSubmitEdit(data: EditOrgFormValues) {
  ...
  function onSubmitAdd(data: AddOrgFormValues) {
            ...
            <AlertDialogContent className="  w-full max-w-3xl h-full lg:max-h-[26em] max-h-[24em]">
              <AlertDialogHeader>
                <AlertDialogTitle>
                  ...
                  <AlertDialogCancel className="h-auto p-0 border-0" onClick={() => { resetFormAdd(); }}>
                    <IoMdClose />
                  </AlertDialogCancel>
                </AlertDialogTitle>
                    ...
                    <Form {...formAdd}>
                      ...
                      >
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="w-full ">
                                ...
                                <FormControl>
                                  <Input
                                    placeholder="عنوان سازمان  را وارد نمایید"
                                    {...field}
                                    className="bg-white"
                                  />
                                </FormControl>
                        ...
                        <div className="flex justify-center w-full gap-2 mt-8 sm:justify-end">
                          ...
                          <AlertDialogCancel className="mt-0 text-white bg-blue rounded-xl" onClick={() => { resetFormAdd(); }}>
                            بستن
                          </AlertDialogCancel>
                        </div>
                      </form>
