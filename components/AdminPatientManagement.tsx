...
import { PatientCardItems } from "@/constants";
import TablePatient from "./TableAdmin";
    ...
    <div className="w-full bg-[#F5F5F5] min-h-[85vh] flex justify-center">
      <div className="w-[95vw] lg:w-[85vw] 3xl:w-[70vw] mt-8 max-sm:mt-16 pt-9 ">
        <div className="w-full flex flex-col gap-5  ">
          ...
          {/* 2 */}
          <div className="w-full flex flex-row max-md:flex-wrap justify-center gap-3 mt-5">
